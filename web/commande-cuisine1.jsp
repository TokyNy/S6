...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Commande en cuisine</h4>
                    </div>
       ...
       Commande en cuisine
                 ...
                 <% 
            Vector<AdditionDetails>  liste=Cuisine.getListeCommande();
        ...
        %>
                     <table class="table">
                         ...
                         <tr>
                             ...
                             <td><a href="commandeCuite.jsp?idAdditionDetails=<% out.print(liste.get(i).getId()); %>">finir</a></td>
                         </tr>
                         <% } %>
                     </table>
                     <div class="row">
                         <div class="col-md-4"></div>
                         <div class="col-md-4"><p><a href="addition-par-table1.jsp">livraison</a></p></div>
                         <div class="col-md-4"></div>
                     </div>
